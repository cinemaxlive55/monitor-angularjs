...
@Component({
  selector: 'cassandra',
  templateUrl: 'cassandra.template.html'
})
...
export class CassandraComponent implements OnInit {
  ...
  public flotDatasetKeyCache: any = [
    {
  ...
  public flotOptionsKeyCache: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
  ...
  public flotDatasetNumOfRestart: any = [
    {
      label: "Number of orders",
      data: this.data2,
      color: "#1ab394",
  ...
  public flotOptionsNumOfRestart: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
  ...
  constructor(private promethueusService: PromethueusService, private location: Location) {
  ...
  ngOnInit() {
    console.log(this.promethueusService.getPromethusData_conter_status_200_health().then(data => {
      this.data = data;
