...
@Component({
  selector: 'fluentd',
  templateUrl: 'fluentd.template.html'
})

export class FluentdComponent implements OnDestroy, OnInit {
  ...
  public flotDatasetNumOfNodesForwardingLogs: any = [
    {
  ...
  public flotOptionsNumOfNodesForwardingLogs: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
  ...
  public flotDatasetNumberOfLogs: any = [
    {
      label: "Number of orders",
      data: this.data2,
      color: "#1ab394",
  ...
  public flotOptionsNumberOfLogs: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
  ...
  public flotDatasetCurrentRetryCount: any = [
    {
      label: "Number of orders",
      data: this.data2,
      color: "#1ab394",
  ...
  public flotOptionsCurrentRetryCount: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
