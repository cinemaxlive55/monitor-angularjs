...
@Component({
  selector: 'kafka',
  templateUrl: 'kafka.template.html'
})

export class KafkaComponent implements OnDestroy, OnInit {
  ...
  public flotDatasetOfflinePartitions: any = [
    {
  ...
  public flotOptionsOfflinePartitions: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
  ...
  public flotDatasetMessagePerSecond: any = [
    {
      label: "Number of orders",
      data: this.data2,
      color: "#1ab394",
  ...
  public flotOptionsMessagePerSecond: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
  ...
  public flotDatasetRequestsPerSecond: any = [
    {
      label: "Number of orders",
      data: this.data2,
      color: "#1ab394",
  ...
  public flotOptionsRequestsPerSecond: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
  ...
  public flotDatasetCommitsPerSecond: any = [
    {
      label: "Number of orders",
      data: this.data2,
      color: "#1ab394",
  ...
  public flotOptionsCommitsPerSecond: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
  ...
  public flotDatasetUnderReplicatedPartitions: any = [
    {
      label: "Number of orders",
      data: this.data2,
      color: "#1ab394",
  ...
  public flotOptionsUnderReplicatedPartitions: any =
    {
      xaxis: {
        mode: "time",
        tickSize: [3, "day"],
